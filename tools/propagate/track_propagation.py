...
def parse_args():
    ...
    parser.add_argument('vid_file', help='Video protocol file.')
    parser.add_argument('track_file', help='Reference track protocol file.')
    parser.add_argument('save_file', help='Save new track protocol file.')
